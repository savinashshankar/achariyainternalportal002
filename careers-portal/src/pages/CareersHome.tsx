        ...
        <div className="min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-purple-50">
            ...
            <header className="bg-white/90 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Achariya Careers</h1>
                            <p className="text-sm text-gray-600">Join Our Team. Shape the Future.</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
                ...
                <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                    School. College. Corporate. One place to apply.
                    <br />
            ...
            <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Link
                        to="/school"
                        className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 p-8 text-white hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
                    >
                        ...
                        <Building2 className="w-16 h-16 mb-4 relative z-10" />
                        <h3 className="text-3xl font-bold mb-2 relative z-10">School</h3>
                        <p className="text-blue-100 mb-4 relative z-10">
                            Teachers, coordinators, and school staff roles
                        </p>
                        <div className="flex items-center justify-between relative z-10">
                            <span className="text-2xl font-bold">{getCategoryCount('School')} Openings</span>
