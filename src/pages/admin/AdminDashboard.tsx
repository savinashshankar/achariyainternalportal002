...
const AdminDashboard = () => {
    const totalUsers = sampleData.students.length + sampleData.teachers.length + 2; // +2 for principals
        ...
        <div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border mb-6 sm:mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {sampleData.schools.map((school) => {
                        ...
                        const schoolTeachers = sampleData.teachers.filter(t => t.school_id === school.id);
                        const schoolCourses = sampleData.courses.filter(c => c.school_id === school.id);
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-600 mb-3">{school.location} • {school.type}</p>
                                <div className="grid grid-cols-3 gap-4 text-center">
                                    ...
                                    <div>
                                        <p className="text-2xl font-bold text-green-600">{schoolTeachers.length}</p>
                                        <p className="text-xs text-gray-600">Teachers</p>
                                    </div>
                                    <div>
                                        <p className="text-2xl font-bold text-purple-600">{schoolCourses.length}</p>
            ...
            <div className="mb-6 sm:mb-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                        <p className="text-3xl font-bold text-gray-800">{sampleData.teachers.length}</p>
                        <p className="text-sm text-gray-600">Teachers</p>
                    </div>
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                        <p className="text-3xl font-bold text-gray-800">{sampleData.enrollments.length}</p>
